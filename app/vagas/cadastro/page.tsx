      ...
      <Card className="mx-auto w-full py-8">
        <form action={createJobAction}>
          <CardContent className="space-y-6">
            {state?.error && (
              <div className="flex items-center gap-4 rounded-mb border border-red-200 bg-red-100 p-4 py-6 text-red-900">
            ...
            <FormItem 
              ...
              description="Nome da empresa que será exibido na busca. Não é necessário colocar razão social."
            >
              <Input 
                className="rounded-xs border-gray-500"
                id="company"
